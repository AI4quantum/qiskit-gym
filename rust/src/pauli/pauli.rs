...
mod tests {
    ...
    #[test]
    fn test_evolve_h() {
        let mut pauli = Pauli::from_label("XYZ").unwrap();
        pauli.evolve_h(2);
        assert_eq!(pauli.base_z, vec![true, true, true]);
        assert_eq!(pauli.base_x, vec![false, true, false]);
        assert_eq!(pauli.base_phase, 1);
        ...
        pauli = Pauli::from_label("iXYZ").unwrap();
        pauli.evolve_h(1);
        assert_eq!(pauli.base_z, vec![true, true, false]);
        assert_eq!(pauli.base_x, vec![false, true, true]);
        assert_eq!(pauli.base_phase, 2);
        ...
        pauli = Pauli::from_label("-XYZ").unwrap();
        pauli.evolve_h(0);
        assert_eq!(pauli.base_z, vec![false, true, false]);
        assert_eq!(pauli.base_x, vec![true, true, true]);
        assert_eq!(pauli.base_phase, 3);
    }
    ...
    fn test_evolve_s() {
        ...
        pauli = Pauli::from_label("XYZ").unwrap();
        pauli.evolve_s(1);
        assert_eq!(pauli.base_z, vec![true, false, false]);
        assert_eq!(pauli.base_x, vec![false, true, true]);
        assert_eq!(pauli.base_phase, 2);
    ...
    fn test_evolve_sx() {
        ...
        pauli.evolve_sx(1);
        assert_eq!(pauli.base_z, vec![true, true, false]);
        assert_eq!(pauli.base_x, vec![false, false, true]);
        assert_eq!(pauli.base_phase, 0);
    ...
    fn test_commutes_with() {
        let pauli1 = Pauli::from_label("XYZ").unwrap();
        let pauli2 = Pauli::from_label("XIZ").unwrap();
        assert!(pauli1.commutes_with(&pauli2));

        let pauli3 = Pauli::from_label("ZZI").unwrap();
        assert!(pauli1.commutes_with(&pauli3));

        let pauli4 = Pauli::from_label("XX").unwrap();
        assert!(pauli4.commutes_with(&Pauli::from_label("XI").unwrap()));
        assert!(pauli4.commutes_with(&Pauli::from_label("XX").unwrap()));
        assert!(!pauli4.commutes_with(&Pauli::from_label("XY").unwrap()));
        assert!(!pauli4.commutes_with(&Pauli::from_label("XZ").unwrap()));
        assert!(pauli4.commutes_with(&Pauli::from_label("ZZ").unwrap()));
        assert!(pauli4.commutes_with(&Pauli::from_label("XIYII").unwrap()));
    }
}
